...
window.addEventListener("scroll", () => {
    ...
    if (window.scrollY > (window.innerHeight * 3.5)) { certificates.style.color = "#7B88FF"; projects.style.color = "#BDBDBD" } else { certificates.style.color = "#BDBDBD"; }
    if (window.scrollY > (window.innerHeight * 4.5)) { studies.style.color = "#7B88FF"; certificates.style.color = "#BDBDBD" } else { studies.style.color = "#BDBDBD"; }
    if (window.scrollY > (window.innerHeight * 6)) { contact.style.color = "#7B88FF"; studies.style.color = "#BDBDBD" } else { contact.style.color = "#BDBDBD"; }
